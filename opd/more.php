<?php 
	...
	if($_GET['apa']=="pengajuan"){ ?>

<?php 
	$query = mysqli_query($koneksi,"SELECT * FROM pengajuan INNER JOIN opd ON pengajuan.id_opd=opd.id_opd WHERE id_pengajuan='".$_GET['id_pengajuan']."'");
	$r=mysqli_fetch_assoc($query);
 ?>
<b>Di Laporakan Pada : <?php echo $r['tgl_pengajuan']; ?></b><br>
