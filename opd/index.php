<?php 
 ...
 ?>
  ...
  <html>
    <head>
    	<title>Applikasi Propemperda</title>
    ...
    <body style="background:url(); background-size: cover;">
          ...
          <ul id="slide-out" class="sidenav sidenav-fixed">
              <li>
                  <div class="user-view">
                      ...
                      <a href="#name"><span class="blue-text name"><?php echo ucwords($_SESSION['data']['nama']); ?></span></a><?php echo date('l, d-m-Y');?>                    
                  </div>
              </li>
              <li><a href="index.php?p=dashboard"><i class="material-icons">dashboard</i>Dashboard</a></li>
              <li><a href="index.php?p=laporan"><i class="material-icons">description</i>Laporan</a></li>
              <li>
    ...
    elseif(@$_GET['p']=="laporan"){
		...
		elseif(@$_GET['p']=="pengajuan_hapus"){
			...
			elseif($data['status']=="selesai"){
				$delete=mysqli_query($koneksi,"DELETE FROM pengajuan WHERE id_pengajuan='".$_GET['id_pengajuan']."'");
				if($delete){
					$delete2=mysqli_query($koneksi,"DELETE FROM tanggapan WHERE id_pengajuan='".$_GET['id_pengajuan']."'");
					header('location:index.php?p=dashboard');
				}	
			}
